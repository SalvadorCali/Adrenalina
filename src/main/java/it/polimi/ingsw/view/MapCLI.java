...
public class MapCLI {
    ...
    public void printMap(){
        ...
        String spaceA6 = SPACE;
        String spaceA7 = SPACE;
        String spaceA8 = SPACE;
        String spaceA9 = SPACE;
        String spaceA10 = SPACE;
        String spaceA11 = ammo;
        String spaceA12 = spawnPoint;



        //second square
        String spacePlayer2[] = new String[MAX_NUM_PLAYER];
        String spaceB6 = SPACE;
        String spaceB7 = SPACE;
        String spaceB8 = SPACE;
        String spaceB11 = ammo;
        String spaceB12 = spawnPoint;


        //third square
        String spacePlayer3[] = new String[MAX_NUM_PLAYER];
        String spaceC6 = SPACE;
        String spaceC7 = SPACE;
        String spaceC8 = SPACE;
        String spaceC11 = ammo;
        String spaceC12 = spawnPoint;


        //fourth square
        String spacePlayer4[] = new String[MAX_NUM_PLAYER];
        String spaceD6 = SPACE;
        String spaceD7 = SPACE;
        String spaceD8 = SPACE;
        String spaceD11 = ammo;
        String spaceD12 = spawnPoint;



        //fifth square
        String spacePlayer5[] = new String[MAX_NUM_PLAYER];
        String spaceE11 = ammo;
        String spaceE12 = spawnPoint;



        //sixth square
        String spacePlayer6[] = new String[MAX_NUM_PLAYER];
        String spaceF11 = ammo;
        String spaceF12 = spawnPoint;


        //seventh square
        String spacePlayer7[] = new String[MAX_NUM_PLAYER];
        String spaceG11 = ammo;
        String spaceG12 = spawnPoint;


        //eighth square
        String spacePlayer8[] = new String[MAX_NUM_PLAYER];
        String spaceH11 = ammo;
        String spaceH12 = spawnPoint;


        //ninth square
        String spacePlayer9[] = new String[MAX_NUM_PLAYER];
        String spaceI11 = ammo;
        String spaceI12 = spawnPoint;


        //tenth square
        String spacePlayer10[] = new String[MAX_NUM_PLAYER];
        String spaceL11 = ammo;
        String spaceL12 = spawnPoint;


        //eleventh square
        String spacePlayer11[] = new String[MAX_NUM_PLAYER];
        String spaceM11 = ammo;
        String spaceM12 = spawnPoint;


        //twelfth square
        String spacePlayer12[] = new String[MAX_NUM_PLAYER];
        String spaceN11 = ammo;
        String spaceN12 = spawnPoint;
       ...
       for(int i = 0; i < ROWS; i++){
        ...
        System.out.print(colorSquare[0][0] + wallWest[0] + spacePlayer1[4] + SPACE + spaceA6 + SPACE + spaceA7 + SPACE + spaceA8 + colorSquare[0][0] + wallEast[0] + SPACE + colorSquare[0][1] + wallWest[1] + spacePlayer2[4] + SPACE + spaceB6 + SPACE + spaceB7 + SPACE + spaceB8 + colorSquare[0][1] + wallEast[1] + SPACE + colorSquare[0][2] + wallWest[2] + spacePlayer3[4] + SPACE + spaceC6 + SPACE + spaceC7 + SPACE + spaceC8 + colorSquare[0][2] + wallEast[2] + SPACE  + colorSquare[0][3] + wallWest[3] + spacePlayer4[4] + SPACE + spaceD6 + SPACE + spaceD7 + SPACE + spaceD8 + colorSquare[0][3] + wallEast[3] + "\n" + RESET);
        System.out.print(colorSquare[0][0] + "|" + CYAN + spaceA9 + SPACE + spaceA10 + SPACE + spaceA11+ SPACE + spaceA12 + colorSquare[0][0] + "|" + SPACE + colorSquare[0][1] + "|" + CYAN +spaceA9 + SPACE + spaceA10 + SPACE + spaceB11 + SPACE + spaceB12 + colorSquare[0][1] + "|" + SPACE + colorSquare[0][2] + "|" + CYAN +spaceA9 + SPACE + spaceA10 + SPACE + spaceC11 + SPACE + spaceC12 + colorSquare[0][2] + "|"+ SPACE  + colorSquare[0][3] + "|" + CYAN +spaceA9 + SPACE + spaceA10 + SPACE + spaceD11 + SPACE + spaceD12 + colorSquare[0][3] + "|\n" + RESET);
        ...
        System.out.print(colorSquare[1][0] + wallWest[4] + spacePlayer5[4] + SPACE + spaceA6 + SPACE + spaceA7 + SPACE + spaceA8 + colorSquare[1][0] + wallEast[4] + SPACE + colorSquare[1][1] + wallWest[5] + spacePlayer6[4] + SPACE + spaceB6 + SPACE + spaceB7 + SPACE + spaceB8 + colorSquare[1][1] + wallEast[5] + SPACE + colorSquare[1][2] + wallWest[6] + spacePlayer7[4] + SPACE + spaceC6 + SPACE + spaceC7 + SPACE + spaceC8 + colorSquare[1][2] + wallEast[6] + SPACE  + colorSquare[1][3] + wallWest[7] + spacePlayer8[4] + SPACE + spaceD6 + SPACE + spaceD7 + SPACE + spaceD8 + colorSquare[1][3] +  wallEast[7] + "\n" + RESET);
        System.out.print(colorSquare[1][0] + "|" + CYAN + spaceA9 + SPACE + spaceA10 + SPACE + spaceE11 + SPACE + spaceE12 + colorSquare[1][0] + "|" + SPACE + colorSquare[1][1] + "|" + CYAN +spaceA9 + SPACE + spaceA10 + SPACE + spaceF11 + SPACE + spaceF12 + colorSquare[1][1] + "|" + SPACE + colorSquare[1][2] + "|" + CYAN +spaceA9 + SPACE + spaceA10 + SPACE + spaceG11 + SPACE + spaceG12 + colorSquare[1][3] + "|"+ SPACE  + colorSquare[1][3] + "|" + CYAN +spaceA9 + SPACE + spaceA10 + SPACE + spaceH11 + SPACE + spaceH12 + colorSquare[1][3] + "|\n" + RESET);
        ...
        System.out.print(colorSquare[2][0] + wallWest[8] + spacePlayer9[4] + SPACE + spaceA6 + SPACE + spaceA7 + SPACE + spaceA8 + colorSquare[2][0] + wallEast[8] + SPACE + colorSquare[2][1] + wallWest[9] + spacePlayer10[4] + SPACE + spaceB6 + SPACE + spaceB7 + SPACE + spaceB8 + colorSquare[2][1] + wallEast[9] + SPACE + colorSquare[2][2] + wallWest[10] + spacePlayer11[4] + SPACE + spaceC6 + SPACE + spaceC7 + SPACE + spaceC8 + colorSquare[2][2] + wallEast[10] + SPACE  + colorSquare[2][3] + wallWest[11] + spacePlayer12[4] + SPACE + spaceD6 + SPACE + spaceD7 + SPACE + spaceD8 + colorSquare[2][3] + wallEast[11] + "\n" + RESET);
        System.out.print(colorSquare[2][0] + "|" + CYAN + spaceA9 + SPACE + spaceA10 + SPACE + spaceI11 + SPACE + spaceI12 + colorSquare[2][0] + "|" + SPACE + colorSquare[2][1] + "|" + CYAN +spaceA9 + SPACE + spaceA10 + SPACE + spaceL11 + SPACE + spaceL12 + colorSquare[2][1] + "|" + SPACE + colorSquare[2][2] + "|" + CYAN +spaceA9 + SPACE + spaceA10 + SPACE + spaceM11 + SPACE + spaceM12 + colorSquare[2][2] + "|"+ SPACE  + colorSquare[2][3] + "|" + CYAN +spaceA9 + SPACE + spaceA10 + SPACE + spaceN11 + SPACE + spaceN12 + colorSquare[2][3] + "|\n" + RESET);
