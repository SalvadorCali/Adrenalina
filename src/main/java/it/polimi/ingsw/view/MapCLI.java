...
public class MapCLI {
    ...
    public void printMap(){
       ...
       for(int i = 0; i < ROWS; i++){
        ...
        System.out.print(colorSquare[0][0] + "|" + CYAN + space + SPACE + space + SPACE + spaceAmmoPoint[0] + SPACE + spaceSpawnPoint[0] + colorSquare[0][0] + "|" + SPACE + colorSquare[0][1] + "|" + CYAN +space + SPACE + space + SPACE + spaceAmmoPoint[1] + SPACE + spaceSpawnPoint[1] + colorSquare[0][1] + "|" + SPACE + colorSquare[0][2] + "|" + CYAN +space + SPACE + space + SPACE + spaceAmmoPoint[2] + SPACE + spaceSpawnPoint[2] + colorSquare[0][2] + "|"+ SPACE  + colorSquare[0][3] + "|" + CYAN +space + SPACE + space + SPACE + spaceAmmoPoint[3] + SPACE + spaceSpawnPoint[3] + colorSquare[0][3] + "|\n" + RESET);
        ...
        System.out.print(colorSquare[2][0] + "|" + CYAN + space + SPACE + space + SPACE + spaceAmmoPoint[8] + SPACE + spaceSpawnPoint[8] + colorSquare[2][0] + "|" + SPACE + colorSquare[2][1] + "|" + CYAN +space + SPACE + space + SPACE + spaceAmmoPoint[9] + SPACE + spaceSpawnPoint[9] + colorSquare[2][1] + "|" + SPACE + colorSquare[2][2] + "|" + CYAN +space + SPACE + space + SPACE + spaceAmmoPoint[10] + SPACE + spaceSpawnPoint[10] + colorSquare[2][2] + "|"+ SPACE  + colorSquare[2][3] + "|" + CYAN +space + SPACE + space + SPACE + spaceAmmoPoint[11] + SPACE + spaceSpawnPoint[11] + colorSquare[2][3] + "|\n" + RESET);
