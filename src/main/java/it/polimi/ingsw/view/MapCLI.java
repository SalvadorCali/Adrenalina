...
public class MapCLI {
    ...
    public void printMap(){
       ...
       for(int i = 0; i < ROWS; i++){
        ...
        //second row
        Printer.print(colorSquare[1][0] + " _ " + wallNorth[4] + SPACE  + wallNorth[4] + " _" + SPACE + colorSquare[1][1] + "  _ " + wallNorth[5] + " " + wallNorth[5] + " _" + SPACE + colorSquare[1][2] + "  _ " + wallNorth[6] + SPACE  + wallNorth[6] + " _"   + SPACE + colorSquare[1][3] + "  _ " + wallNorth[7] + " " + wallNorth[7] + " _\n"  + RESET);
